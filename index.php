                      ...
                      <?php if ($rol == 2): ?>
                        <td>
                          <?php if ($fila['estado'] == "Activo"): ?>
                            <a class="btn btn-primary btn-sm" title="editar" onclick="editarPersona(<?php echo $fila['IDempleado']; ?>)">
                              <i class="bi bi-pencil-square"></i>
                            </a>

                            <a class="btn btn-danger btn-sm"
                              href="javascript:void(0);"
                              onclick="eliminarEmpleado(<?php echo $fila['IDempleado']; ?>)"
                              title="Eliminar">
                ...
                <form id="formAgregarPersona" class="text-start" action="agregar.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="cargo" name="cargo" required>
                            ...
                            <?php
                            $consultaCargos = $mysql->efectuarConsulta("SELECT IDcargo, nombreCargo FROM cargos");
                    ...
                    <div class="mb-3">
                        ...
                        <?php
                        $consultaDepartamentos = $mysql->efectuarConsulta("SELECT IDdepartamento, nombreDepartamento FROM departamentos");
                        while ($fila = $consultaDepartamentos->fetch_assoc()): ?>
                        <div class="form-check
    form-check-inline">
                                <input class="form-check-input" type="radio" name="area" value="<?php echo $fila['IDdepartamento']; ?>" required>
                                <label class="form-check-label"><?php echo $fila['nombreDepartamento']; ?></label>
                            </div>
                        <?php endwhile; ?>
                    </div>
                    <div class="mb-3">
