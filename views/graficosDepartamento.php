...
$cargoUsuario = $consultaCargo->fetch_assoc()['nombreCargo'] ?? 'Sin Departamento ';
    ...
    <main class="app-main">
      ...
      <div class="app-content-header">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-6">
              <h3 class="mb-0">Graficos por Departamento</h3>
              <button class="btn btn-secondary" onclick="history.back()">← Volver</button>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-end">
                <li class="breadcrumb-item"><a href="../index.php">Graficos</a></li>
                <li class="breadcrumb-item active" aria-current="page">Graficos por Departamento</li>
              </ol>
            </div>
          </div>
          <!--end::Row-->
            ...
            <div class="col-md-8">
              <div class="card shadow-lg border-0 rounded-4">
                <div class="card-header bg-primary text-white text-center rounded-top-4">
                  <h5 class="mb-0">📊 Cantidad de Empleados por Departamento</h5>
                </div>
                <div class="card-body">
                  <canvas id="grafico1" style="max-height: 400px;"></canvas>
                </div>
              </div>
            </div>
          </div>
