      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0">Graficos por Cargo</h3>
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Graficos por Cargo</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-md-8">
                    ...
                    <div class="card-header bg-primary text-white text-center rounded-top-4">
                        <h5 class="mb-0">📊 Cantidad de Empleados por Cargo</h5>
                    </div>
                    <div class="card-body">
                        <canvas id="grafico2" style="max-height: 400px;"></canvas>
                    </div>
                    </div>
                </div>
            </div>
